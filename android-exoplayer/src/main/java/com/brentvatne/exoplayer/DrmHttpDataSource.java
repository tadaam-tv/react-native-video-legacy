 ...
 * {@link #DrmHttpDataSource(String, Predicate, TransferListener, int, int, boolean,
 * RequestProperties)} constructor and passing {@code true} as the second last argument.
 */
public class DrmHttpDataSource implements HttpDataSource {
    ...
    private static final String TAG = "DrmHttpDataSource";
    ...
    private final TransferListener<? super DrmHttpDataSource> listener;
     ...
     *     {@link #open(DataSpec)}.
     */
    public DrmHttpDataSource(String userAgent, Predicate<String> contentTypePredicate) {
     ...
     */
    public DrmHttpDataSource(String userAgent, Predicate<String> contentTypePredicate,
                                 TransferListener<? super DrmHttpDataSource> listener) {
     ...
     */
    public DrmHttpDataSource(String userAgent, Predicate<String> contentTypePredicate,
                                 TransferListener<? super DrmHttpDataSource> listener, int connectTimeoutMillis,
